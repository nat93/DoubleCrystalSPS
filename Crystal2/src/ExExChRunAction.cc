...
//    analysisManager->OpenFile(fileName);
    ...
    tree_2 = new TTree("Tree_2", "A Tree with H8 Data for Sensor Plane 2");
    ...
    tree_2->Branch("EventID",   &_Event_ID_2);
    tree_2->Branch("X",         &_X_2);
    tree_2->Branch("Y",         &_Y_2);
    tree_2->Branch("Z",         &_Z_2);
    tree_2->Branch("Xp",        &_Xp_2);
    tree_2->Branch("Yp",        &_Yp_2);
    tree_2->Branch("Mom",       &_Mom_2);
    tree_2->Branch("MomX",      &_Mom_X_2);
    tree_2->Branch("MomY",      &_Mom_Y_2);
    tree_2->Branch("MomZ",      &_Mom_Z_2);
    tree_2->Branch("parID",     &_par_ID_2);
    tree_2->Branch("Q",         &_Q_2);
    tree_2->Branch("name",      &_name_2);
    tree_2->Branch("CH",        &_CH_2);
}
