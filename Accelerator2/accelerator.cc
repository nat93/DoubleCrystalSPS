...
void function_2(TString input_file_name, TString output_file_name)
{
    ...
    for(Int_t iEntry = 0; iEntry < nEntries; iEntry++)
    {
        ...
        h_1->Fill(gr_particle_x->Eval(Constants::_cry3_51799_ua9_pos),gr_particle_y->Eval(Constants::_cry3_51799_ua9_pos));
        h_2->Fill(_Mom);
        h_3->Fill(gr_particle_xp->Eval(Constants::_cry3_51799_ua9_pos));
        h_4->Fill(gr_particle_yp->Eval(Constants::_cry3_51799_ua9_pos));
        ...
        _Z_1         = Constants::_cry3_51799_ua9_pos;
...
void passMagnets(Double_t s, Double_t* coord_x0, Double_t* coord_x, Double_t p, Double_t Charge_C, TGraph *gr_x, TGraph *gr_y, TGraph *gr_xp, TGraph *gr_yp, Bool_t print)
{
    ...
    Double_t DRIFTL0 = Constants::_cry3_51799_ua9_pos - Constants::_xrph0_51779_ua9_pos;   // [m]
    ...
    {
        // INITIAL
        if(print) printf("%10.15f , %10.15f , %10.15f\n",coord_x0[0],coord_x0[1],Constants::_xrph0_51779_ua9_pos);
        gr_x->SetPoint(gr_x_ipoint,Constants::_xrph0_51779_ua9_pos,coord_x0[0]);
        gr_xp->SetPoint(gr_x_ipoint,Constants::_xrph0_51779_ua9_pos,coord_x0[1]);
        gr_y->SetPoint(gr_y_ipoint,Constants::_xrph0_51779_ua9_pos,coord_x0[2]);
        gr_yp->SetPoint(gr_y_ipoint,Constants::_xrph0_51779_ua9_pos,coord_x0[3]);
        gr_x_ipoint++;
        gr_y_ipoint++;

        s_status = kTRUE;
    }
    if(!s_status && s < Constants::_cry3_51799_ua9_pos - Constants::_xrph0_51779_ua9_pos)
    {
        DRIFTL0 = Constants::_cry3_51799_ua9_pos - (Constants::_xrph0_51779_ua9_pos + s);
        // DRIFT0-S
        if(!magnet->GetNewCoordDrift(DRIFTL0,order,coord_x0,coord_x,APH,APV))
        {if(print) cout<<"## At : "<<"DRIFT"<<" [m] ##"<<endl; /*continue;*/}
        if(print) printf("%10.15f , %10.15f , %10.15f\n",coord_x0[0],coord_x0[1],Constants::_xrph0_51779_ua9_pos+s);
        gr_x->SetPoint(gr_x_ipoint,Constants::_xrph0_51779_ua9_pos+s,coord_x0[0]);
        gr_xp->SetPoint(gr_x_ipoint,Constants::_xrph0_51779_ua9_pos+s,coord_x0[1]);
        gr_y->SetPoint(gr_y_ipoint,Constants::_xrph0_51779_ua9_pos+s,coord_x0[2]);
        gr_yp->SetPoint(gr_y_ipoint,Constants::_xrph0_51779_ua9_pos+s,coord_x0[3]);
        gr_x_ipoint++;
        gr_y_ipoint++;
    ...
    {
        // FINAL
        if(print) printf("%10.15f , %10.15f , %10.15f\n",coord_x[0],coord_x[1],Constants::_cry3_51799_ua9_pos);
        gr_x->SetPoint(gr_x_ipoint,Constants::_cry3_51799_ua9_pos,coord_x[0]);
        gr_xp->SetPoint(gr_x_ipoint,Constants::_cry3_51799_ua9_pos,coord_x[1]);
        gr_y->SetPoint(gr_y_ipoint,Constants::_cry3_51799_ua9_pos,coord_x[2]);
        gr_yp->SetPoint(gr_y_ipoint,Constants::_cry3_51799_ua9_pos,coord_x[3]);
    }
}
