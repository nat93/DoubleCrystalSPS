...
fWorldLogic(0),fXtalLogic(0){
    ...
    // 2018 //
    //====================================================================//
    fXtalAngle = G4ThreeVector(-4.88183e-05 * CLHEP::radian,0.,0.);
    fXtalSize = G4ThreeVector(1.5 * CLHEP::millimeter,
                              50. * CLHEP::millimeter,
                              4. * CLHEP::millimeter);
    fXtalCurvatureRadius = G4ThreeVector(13.3 * CLHEP::meter,
                                         0. * CLHEP::meter,
                                         0. * CLHEP::meter);
    //====================================================================//
    //====================================================================//
...
G4VPhysicalVolume* ExExChDetectorConstruction::Construct(){
    ...
    new G4PVPlacement(0,G4ThreeVector(0,0, -3.25 * CLHEP::millimeter),phantom_log_0,"phantom_0",fWorldLogic,false,0);
    ...
    if(fXtalCurvatureRadius.x() != 0.){
        ...
        fXtalPhysical =
            new G4PVPlacement(vRotationMatrix,
                              G4ThreeVector(-fXtalCurvatureRadius.x()-0.00244892 * CLHEP::meter,0.,-fXtalSize.z()/2.),
                              fXtalLogic,"Target",
                              fWorldLogic,
                              false,
                              0);
